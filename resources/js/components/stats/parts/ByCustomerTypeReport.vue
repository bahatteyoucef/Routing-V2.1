<template>
    ...
    <div>
        ...
        <!-- Show Chart         -->
        <div    v-show="show_by_customer_type_report_chart_data"    class="row animate__animated animate__pulse">
        ...
        <!-- Show Table         -->
        <div    v-show="show_by_customer_type_report_table_data"    class="row animate__animated animate__pulse mt-5">
            <div class="table_scroll table_scroll_x table_scroll_y table_container">
...
export default {
    ...
    data() {
        return {
            ...
            show_by_customer_type_report_chart_data     :   true    ,
            show_by_customer_type_report_table_data     :   false   
        }
    },

    props : ["by_customer_type_report_chart_data", "by_customer_type_report_table_data"],
    ...
    async mounted() {
        ...
        //
        this.emitter.emit('show_by_customer_type_report_content_ready')
    },
    ...
    methods : {
        ...
        toggleChartTable() {
            ...
            if(this.show_by_customer_type_report_chart_data ==  false) {

                this.show_by_customer_type_report_table_data    =   false
                this.show_by_customer_type_report_chart_data    =   true
            }

            else {

                this.show_by_customer_type_report_chart_data    =   false
                this.show_by_customer_type_report_table_data    =   true
            }
        }
    }
}
