<template>
    ...
    <div class="m-3 p-3">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div v-if="show_by_brand_availability_chart"        id="by_brand_availability_reports_container"    class="pt-5 pb-1">
        ...
        <!-- Show Table         -->
        <div v-if="by_brand_availability_table"    class="table_scroll table_container mt-5">
            <table class="table w-100" id="by_brand_availability_reports_table">
                <tr>
...
export default {
    ...
    data() {
        return {
            ...
            show_by_brand_availability_chart        :   false
        }
    },
        ...
        async getData() {
            ...
            try {
                ...
                .then(async (res)=> {
                    ...
                    //
                    this.show_by_brand_availability_chart                =   true
