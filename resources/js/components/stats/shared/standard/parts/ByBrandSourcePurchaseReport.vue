    ...
    <div>
        ...
        <div class="row">
            <div class="col-9 d-flex align-items-center">
                <h5 class="mb-0 ml-2">By Brand Source Purchase Report</h5>
            </div>
        ...
        <div v-show="show_by_brand_source_purchase_report_chart_data"    class="row animate__animated animate__pulse">
            ...
            <div class="col-12">
                ...
                <div            id="by_brand_source_purchase_report_chart_scroll"       class="chart_scroll pt-5 pb-1">
                    <div        id="by_brand_source_purchase_report_chart_container"    class="pie_chart_container">
                        <canvas id="by_brand_source_purchase_report_chart"              ref="by_brand_source_purchase_report_chart"></canvas>
                    </div>
                </div>
                ...
                <table  class="table table-bordered w-100" id="by_brand_source_purchase_report_table_data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>{{ parseInt(by_brand_source_purchase_report_table_data.total_row.percentage_clients * 100) }} %</th>
                        </tr>
                    </tbody>
                </table>
            </div>
...
export default {
    ...
    async mounted() {
        ...
        //
        emitter.emit('show_by_brand_source_purchase_report_content_ready')
    },
    ...
    methods : {
        ...
        setChart() {
            ...
            if (this.by_brand_source_purchase_report_chart) {
                this.by_brand_source_purchase_report_chart.destroy();   // Destroy existing chart for proper updates
            }

            const by_brand_source_purchase_report_chart     =   this.$refs.by_brand_source_purchase_report_chart.getContext('2d');

            this.by_brand_source_purchase_report_chart      =   new Chart(by_brand_source_purchase_report_chart, {
                type                                        :   "doughnut"                                          ,
                data                                        :   this.by_brand_source_purchase_report_chart_data     ,
                options                                     :   {}
            });
        },
