...
export default {
    ...
    methods : {
        ...
        async customerBarCodeImage() {
            ...
            console.log('Heap before:', (performance.memory.usedJSHeapSize / 1024 / 1024).toFixed(2) + ' MB');
            ...
            console.log('Heap after:', (performance.memory.usedJSHeapSize / 1024 / 1024).toFixed(2) + ' MB');
        },
