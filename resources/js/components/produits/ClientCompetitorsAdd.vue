    ...
    <div>
        ...
        >
            <div class="col-sm-10 mt-3 mb-3">
                <h4 class="ml-1"> Competitors Analysis :</h4>
            </div>
...
export default {
    ...
    methods : {
        ...
        async sendData() {
            ...
            const res                   =   await this.$callApi("post"  ,   "/competitors_analysis/all/store",   formData)
            console.log(res)
        ...
        async getStockProducts() {
            ...
            const res       =   await this.$callApi("post",     "/route_import/"+this.$route.params.id_route_import+"/products/competitors",      null)
